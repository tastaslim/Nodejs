...
// 256KiB
exports.DEFAULT_MAX_SQS_MESSAGE_SIZE = 256 * 1024;
class SqsProducer {
    constructor(options) {
        var _a;
        if (options.sqs) {
        ...
        this.messageSizeThreshold = (_a = options.messageSizeThreshold) !== null && _a !== void 0 ? _a : exports.DEFAULT_MAX_SQS_MESSAGE_SIZE;
    ...
    async sendS3Payload(s3PayloadMeta, msgSize, options = {}) {
...
//# sourceMappingURL=sqs-producer.js.map